...
class Config(ParamsProto):
    ...
    device = "cuda:0"
    prefix = (
        "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/ll5_org_cumr"
    )
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/hl"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/ll5_org_cumr"
