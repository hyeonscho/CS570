...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/hl60_r2_j4_actpad"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/hl60_r2_j4_actpad"
    )
