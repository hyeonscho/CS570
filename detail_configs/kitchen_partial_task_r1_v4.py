...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/task/40/v4_round1"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/task/40/v4_round1"
    )
    ...
    stitch = False
    task_data = True
    aug_data_file = "/common/users/cc1547/dataset/rainbow/stitching_kitchen/round1_stitch_kitchen_partial_H40-v4.pkl"
    jump = 1
