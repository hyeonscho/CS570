...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/80"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/segment_return"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/80"
