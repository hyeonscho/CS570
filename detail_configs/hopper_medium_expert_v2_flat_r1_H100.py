...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/flat100_r1"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/flat100_r1"
    )
    ...
    dynamic_model_path = "/common/users/cc1547/projects/rainbow/diffstitch/dynamic/hopper-medium-expert-v2/mopo/seed_1_0826_170326-hopper_medium_expert-v2_mopo/models/ite_dynamics_model"
