...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-replay-v2/cl_h8_ad"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/cl"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-replay-v2/cl_h8_ad"
    ...
    task_data = True
    jump = None
    aug_data_file = "/common/users/cc1547/dataset/rainbow/stitching_gym/round1_stitch_halfcheetah-medium-replay-v2_H50-v2.pkl"
    data_file = None
