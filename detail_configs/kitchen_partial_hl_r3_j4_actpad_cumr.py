...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/hl40_r3_j4_actpad_cumr"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/hl"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/hl40_r3_j4_actpad_cumr"
    ...
    ## dataset
    termination_penalty = -80
    returns_scale = 80.0  # Determined using rewards from the dataset
    ...
    ll_loadpath = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/hl/kitchen-partial-v0/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/ll5_r3_cumr/checkpoint"
