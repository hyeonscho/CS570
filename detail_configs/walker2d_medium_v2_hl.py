...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-v2/hl100_r1_run2"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-v2/hl100_r1_run2"
    )
    ...
    save_aug_freq = 5
    ll_loadpath = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl/walker2d-medium-v2/diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-v2/ll10_r1_run2/checkpoint"
