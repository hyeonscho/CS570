...
class Config(ParamsProto):
    ...
    device = "cuda:0"
    prefix = (
        "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/cl_l3/v6_round1"
    )
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/cl_l3"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/cl_l3/v6_round1"
    )
