...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/cl_h_ad"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/cl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/cl_h8_ad"
    )
