...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-v2/ll_10_run2"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/segment_return"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-v2/task/ll_10_run2"
    )
