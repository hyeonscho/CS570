...
class Config(ParamsProto):
    ...
    device = "cuda:0"
    prefix = (
        "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/cl_l2/v6_round3"
    )
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/cl_l2"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/cl_l2/v6_round3"
    )
