...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/cl_h8_run4"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/cl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-expert-v2/cl_h8_run4"
    )
    ...
    dynamic_model_path = "/common/users/cc1547/projects/rainbow/diffstitch/dynamic/hopper-medium-expert-v2/mopo/seed_1_0826_170431-hopper-medium-expert-v2_mopo/models/ite_dynamics_model"
