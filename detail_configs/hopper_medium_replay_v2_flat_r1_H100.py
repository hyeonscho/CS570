...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/flat100_r1"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/flat100_r1"
    )
