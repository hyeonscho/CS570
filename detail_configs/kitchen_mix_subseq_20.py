...
class Config(ParamsProto):
    ...
    device = "cuda:0"
    prefix = (
        "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen_mix/subseq_20"
    )
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_mix/subseq_20"
    ...
    render_freq = 50
    dream_len = 1
    dynamics_deviate = 0.20
    number_optimum = 20000  # 2%
    top_k = 300000  # 30%
    save_img_dir = "/root/4_20_workspace/pictures"
    dynamic_model_path = "/common/users/cc1547/projects/rainbow/diffstitch/dynamic/kitchen-mixed-v0/mopo/seed_1_lr0.001_0923_135949-kitchen_mixed_v0_mopo/models/ite_dynamics_model"
