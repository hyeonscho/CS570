...
class Config(ParamsProto):
    ...
    device = "cuda:0"
    prefix = (
        "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen/hl160/v2_round3"
    )
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/hl160/v2_round3"
    )
