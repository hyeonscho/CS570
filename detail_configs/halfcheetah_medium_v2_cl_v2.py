...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-v2/cl_h9"
    bucket = (
        "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/cl_v2"
    )
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-v2/cl_h9"
