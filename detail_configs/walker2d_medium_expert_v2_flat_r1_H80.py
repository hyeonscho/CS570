...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-expert-v2/flat80_r1"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/walker2d-medium-expert-v2/flat80_r1"
    )
    ...
    task_data = True
    jump = 1
    aug_data_file = "/common/users/cc1547/dataset/rainbow/stitching_gym/round1_stitch_walker2d-medium-expert-v2_H40-v4.pkl"
    data_file = None
