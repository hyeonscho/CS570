...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/hl80_r1"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/hl80_r1"
    )
    ...
    save_aug_freq = 5
    ll_loadpath = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/gym_mujoco/hl/hopper-medium-replay-v2/diffuser/default_inv/predict_epsilon_100_1000000.0/dropout_0.25/hopper-medium-replay-v2/ll40_r1/checkpoint"
