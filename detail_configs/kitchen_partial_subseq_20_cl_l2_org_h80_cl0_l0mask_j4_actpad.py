...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/subseq_20_l2_org_h80_cl0_l0mask_j4_actpad"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen/cl"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/subseq_20_l2_org_h80_cl0_l0mask_j4_actpad"
    ...
    returns_scale = 2  # Determined using rewards from the dataset
