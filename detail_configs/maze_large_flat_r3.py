...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/maze/flat_round3/inv_only"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/maze/flat_round3/inv_only"
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/maze/flat_round3/inv_only"
    ...
    number_optimum = 40000  # 2%
    top_k = 600000  # 30%
    save_img_dir = "/root/4_20_workspace/pictures"
    dynamic_model_path = "/common/users/cc1547/projects/rainbow/diffstitch/dynamic/AntMaze_Medium-v4/mopo/seed_1_0716_170454-AntMaze_Medium_v4_mopo/models/ite_dynamics_model"
