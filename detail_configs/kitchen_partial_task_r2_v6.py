...
class Config(ParamsProto):
    seed = 100
    device = "cuda:0"
    prefix = "default_inv/predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/task/40/v6_round2"
    bucket = "/common/users/cc1547/projects/rainbow/diffstitch/diffuser/kitchen"
    job_name = (
        "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/task/40/v6_round2"
    )
