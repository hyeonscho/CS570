...
base = {
    "diffusion": {
        ...
        ## serialization
        "logbase": logbase,
        "prefix": "diffusion_hmd_dim_mults/",
    ...
    "plan": {
        ...
        ## serialization
        "vis_freq": 10,
        "prefix": "plans_hmd_dim_mults/release",
        ...
        "restricted_pd": False,
        ## loading
        "diffusion_loadpath": "f:diffusion_hmd_dim_mults/H{horizon}_T{n_diffusion_steps}_S{short_seq_len}_J{jumps}",
