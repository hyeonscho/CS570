...
base = {
    ...
    "plan": {
        ...
        "restricted_pd": False,
        ## loading
        "diffusion_loadpath": "f:stitched_hmd/H{horizon}_T{n_diffusion_steps}_S{short_seq_len}_J{jumps}_JA{jump_action}_AW{action_weight}_R{max_round}_{stitched_method}",
