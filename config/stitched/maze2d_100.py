...
base = {
    ...
    "plan": {
        ...
        ## serialization
        "vis_freq": 10,
        "prefix": "plans_diffuser_diffuser/release",
        ...
        "restricted_pd": False,
        ## loading
        "diffusion_loadpath": "f:diffuser_diffuser/H{horizon}_T{n_diffusion_steps}_J{jump}_AW{action_weight}_R{max_round}_{stitched_method}",
