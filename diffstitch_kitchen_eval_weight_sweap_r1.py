...
Config = import_config("kitchen_partial_task_r1_v3")
...
for weight in [100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000]:

    loadpath_ = os.path.join(loadpath, f"state_{weight}.pt")
    state_dict = torch.load(loadpath_, map_location=Config.device)
...
pdb.set_trace()
with open("./diffstitch_kitchen_eval_v3_r1_weight.pkl", "wb") as f:
