...
Config = import_config("kitchen_partial_H160_r3")
...
loadpath = (
    ...
    "predict_epsilon_100_1000000.0/dropout_0.25/kitchen_partial/160/round3/checkpoint"
)
...
test_ret = [0.25, 0.3, 0.35, 0.4, 0.45]
total_rewards = []
total_num_eval = 100
...
pdb.set_trace()
with open("./diffstitch_kitchen_eval_h160.pkl", "wb") as f:
