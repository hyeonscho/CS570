...
class Trainer(object):
    def __init__(
        ...
        # self.dataset_2 = SequenceDataset(
            ...
            if self.renderer is not None:
                ...
                if self.sample_freq and self.step % self.sample_freq == 0:
                    if (
                        ...
                        self.inv_render_samples(n_samples=self.n_samples)
                    elif (
                        self.model.__class__
    ...
    def save(self):
        ...
        savepath = os.path.join(self.logdir, "checkpoint")
    ...
    def load(self):
        ...
        """
        loadpath = os.path.join(self.logdir, logger.prefix, f"checkpoint/state.pt")
    ...
    def render_reference(self, batch_size=10):
        ...
        savepath = os.path.join(self.logdir, f"sample-{self.step}-reference.png")
