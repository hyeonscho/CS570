...
def sample_and_rank(policy, cond):
    _, samples = policy(cond, batch_size=RS_samples) 
...
args.savepath = args.savepath[:-1] + 'value_guidance_RS'
...
for i in range(n_samples):
    ...
    plan = sample_and_rank(policy, cond)
